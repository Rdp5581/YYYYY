...
bot_token = '7382018705:AAEr1d2xgVAgvBJ1fJl4gm65KFmoDmi3_bk'  # Replace with your bot token
...
ADMIN_ID = 991676173  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @AJGIR_TEAM: {ADMIN_ID}")
